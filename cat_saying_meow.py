...
WHITE = (255, 255, 255)
    ...
    @@ -32,12 +32,13 @@ arrow_left = pygame.image.load('left.png')
...
border_up = pygame.image.load('up1.png')
    ...
    @@ -46,33 +47,39 @@ border_left = pygame.image.load('left1.png')
...
play_button_rect = pygame.Rect(WIDTH // 2 - 100, HEIGHT // 2 - 100, 200, 50)
    ...
    @@ -82,12 +89,18 @@ def draw_text_centered(text, font, color, surface, rect):
